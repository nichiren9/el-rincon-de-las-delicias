...
<body style="background-color:#e6cf4e;">
    ...
    <nav class="nav container2">
        ...
        <ul class="nav__link nav__link--nosotros">
            <li class="nav__items">
                <a href="paginaadministrador.php" class="nav__links">Regresar</a>
            </li>
        </ul>
    </nav>
</body>
...
<section id="cart" class="cart">
    ...
    <h3 id="total-price">Total a pagar: $0.00</h3>
...
<script>
    ...
    function checkout() {
        ...
        // Aquí podrías enviar el carrito al servidor para procesar el pago
