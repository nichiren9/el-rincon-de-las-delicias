...
<body>
    <nav class="fondo-paginaclientes">
        ...
        <ul class="nav__link nav__link--menu">
            <li class="nav__items">
                <a href="menu clientes.php" class="nav__links">Menú</a>
            </li>
            <li class="nav__items">
                <a href="reclamos.php" class="nav__links">Quejas y Reclamos</a>
            </li>
            <li class="nav__items">
                <a href="manual de usuario.pdf" class="nav__links">Manual de Usuario</a>
            </li>
            <li class="nav__items">
